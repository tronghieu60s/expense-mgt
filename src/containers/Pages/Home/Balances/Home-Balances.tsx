import HomeBalances from 'src/components/Pages/Home/Balances/Home-Balances';
import { GROUPS, JARS } from 'src/constant/common';
import * as STORAGE from 'src/constant/storage';
import * as TEXT from 'src/constant/text';
import { getDateNow, parseDateString } from 'src/helpers/datetime';
import { formatMoneyLocal } from 'src/helpers/money';
import { objectKeyToArray, objectTotalValues } from 'src/helpers/object';
...
const HomeBalancesContainer = (): JSX.Element => {
